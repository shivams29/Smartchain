...
describe('Interpreter', () =>{
    ...
    describe('and the code includes SUB',()=>{
        it('subtracts two values',() => {
            expect(
                new Interpreter().runCode([PUSH,3,PUSH,2,SUB,STOP])
            ).toEqual(1);
        })
    })
    ...
    describe('and the code includes DIV',()=>{
        it('divides two values',() => {
            expect(
                new Interpreter().runCode([PUSH,3,PUSH,2,DIV,STOP])
            ).toEqual(1.5);
        })
    })
    ...
    describe('and the code includes AND',()=>{
        it('and of two values',() => {
            expect(
                new Interpreter().runCode([PUSH,1,PUSH,1,AND,STOP])
            ).toEqual(1);
        })
    })
    ...
    describe('and the code includes OR',()=>{
        it('or of two values',() => {
            expect(
                new Interpreter().runCode([PUSH,0,PUSH,1,ADD,STOP])
            ).toEqual(1);
        })
    })
    ...
    describe('and the code includes JUMP',()=>{
        it('jumps to a destination',() => {
            expect(
                new Interpreter().runCode([PUSH, 6 ,JUMP, PUSH , 0 , JUMP, PUSH , 'jump successfull',STOP])
    ...
    describe('and the code includes JUMPI',()=>{
        it('adds two values',() => {
            expect(
                new Interpreter().runCode([PUSH, 8 , PUSH , 1 , JUMPI , PUSH , 0 , JUMP, PUSH , 'jump successfull',STOP])
            ).toEqual('jump successfull');
        })
    })
    ...
    describe('and the code includes invalid destination error',()=>{
        it('throws an error',() => {
            expect( 
                () => new Interpreter().runCode([PUSH, 99 ,JUMP, PUSH , 0 , JUMP, PUSH , 'jump successfull',STOP])
